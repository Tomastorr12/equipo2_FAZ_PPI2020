  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <Link to="/chatsinmicrofono" className="link">
          <img class="foto1" src="https://1.bp.blogspot.com/-MQiwIhDXUmE/X2p2o384i0I/AAAAAAAAAKs/-Azo6mjMzfE6yuXHpklvZZ4AaVYLPav3QCLcBGAsYHQ/s320/iconfinder_General_Office_60_3592837.png" alt="camara ico" height="80px"></img>
          </Link>
        </button>
